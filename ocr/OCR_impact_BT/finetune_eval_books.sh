...
do
    ...
    do  
        ...
        then
            ...
            sacrebleu $flores101_dataset/devtest/${TRG_LANG_CODE}.devtest < $root_output/generation_${SRC_MM100_LANG_CODE}_${TRG_MM100_LANG_CODE}/${TRG_LANG_CODE}.txt --tokenize spm >> $root_output/results.txt
        fi
    done
done